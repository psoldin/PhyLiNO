...
namespace ana {
  ...
  __attribute__((always_inline)) inline bool check_range(int from, int to, const ParameterWrapper& parameter) noexcept {
  ...
  __attribute__((always_inline)) inline bool check_oscillation_parameters(const ParameterWrapper& parameter) noexcept {
